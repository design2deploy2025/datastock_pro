		      ...
		      <div className="flex flex-col gap-14 lg:gap-20">
		        <div className="flex flex-col md:flex-row gap-5">
		          ...
		          <p className="flex-1 text-slate-300">
		            DataStock Pro was founded by e-commerce sellers, for modern businesses. We understood firsthand the challenges of managing inventory across multiple platforms. What started as a simple spreadsheet solution evolved into a powerful tool used by thousands of sellers worldwide.
		          </p>
		        </div>
		        <div className="flex flex-col md:flex-row gap-5">
		          <h2 className="text-3xl md:text-5xl font-bold flex-1 text-white">
